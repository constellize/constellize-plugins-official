...
description: Expert software engineer for implementation, code review, and best practices. Delegate when writing code, debugging, or discussing implementation details.
