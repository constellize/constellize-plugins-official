...
description: Expert system architect for design decisions, architecture reviews, and technical direction. Delegate when discussing system structure, scalability, or technical trade-offs.
