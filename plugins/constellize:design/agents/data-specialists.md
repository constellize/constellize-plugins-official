...
description: Expert in data modeling, storage strategies, and data architecture. Delegate when designing data structures, optimizing queries, or planning data flows.
